...
def buildpipelinebeat_BaseString = 'docker run --rm regiocom/buildpipelinebeat:latest -E \"output.elasticsearch.hosts=[ \"${buildpipelinebeat_ElasticsearchHosts}\" ]\" -E \"buildpipelinebeat.team=${buildpipelinebeat_TeamName}\" -E \"buildpipelinebeat.project=${buildpipelinebeat_ProjectName}\" -E \"buildpipelinebeat.pipeline=${buildpipelinebeat_PipelineName}\" -E \"buildpipelinebeat.status='
